...
$MESS ['REGISTER_FIELD_EMAIL'] = "Контактный e-mail";
...
$MESS ['REGISTER_FIELD_WORK_COMPANY'] = "Название компании";
$MESS ['REGISTER_FIELD_WORK_DEPARTMENT'] = "Департамент / Отдел";
$MESS ['REGISTER_FIELD_WORK_POSITION'] = "Должность";
$MESS ['REGISTER_FIELD_WORK_WWW'] = "Сайт";
$MESS ['REGISTER_FIELD_WORK_PHONE'] = "Телефон компании";
...
$MESS ['USERTYPE'] = "Пользователь";
$MESS ['USERTYPE_PRIVATE'] = "Частное лицо";
$MESS ['USERTYPE_COMPANY'] = "Организация";
$MESS ['name_private'] = "ФИО";
$MESS ['name_company'] = "Название";
$MESS ['director_name'] = "Генеральный директор (ФИО полностью)";
$MESS ['juridical_address'] = "Юридический адрес";
$MESS ['postal_address'] = "Почтовый адрес";
$MESS ['delivery_address'] = "Адрес доставки";
$MESS ['phone'] = "Телефон/факс";
$MESS ['contact_person_name'] = "Контактное лицо ФИО";
$MESS ['contact_person_mail'] = "Контактное лицо e-mail";
$MESS ['contact_person_ICQ'] = "Контактное лицо ICQ";
$MESS ['contact_person_phone'] = "Контактное лицо телефон";
